...
// 안전한 날짜 변환 헬퍼 (Timestamp, Date, string 모두 지원)
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {(() => {
                    const d = toSafeDate(recipient.lastOrderDate);
                    return d ? format(d, "MM/dd", { locale: ko }) : '-';
                  })()}
                </div>
              </CardContent>
            </Card>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-sm text-muted-foreground">
                            {(() => { const d = toSafeDate(order.orderDate); return d ? format(d, 'yyyy-MM-dd HH:mm', { locale: ko }) : '-'; })()}
                          </span>
                ...
                <div className="space-y-2">
                  ...
                  {recipient.createdAt && (
                    <div className="flex items-center gap-2">
                      ...
                      <span>{(() => { const d = toSafeDate(recipient.createdAt); return d ? format(d, 'yyyy-MM-dd HH:mm', { locale: ko }) : '-'; })()}</span>
                    </div>
                  )}
                </div>
              </CardContent>
